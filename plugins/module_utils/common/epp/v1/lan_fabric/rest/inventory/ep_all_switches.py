"""Endpoint Parser for EpAllSwitches (`/api/v1/lan-fabric/rest/inventory/allswitches`)"""
#
...
from ......classes.exceptions import ControllerResponseError
from ......properties.rest_send import RestSendProperty
from ......properties.results import ResultsProperty
...
class AllSwitches:
    ...
    def update_results(self) -> None:
        ...
        try:
            ...
            # AllSwitches never changes the controller state
    ...
    def refresh(self):
        """
        Refresh all_switches with current switch details from
        the controller.
    ...
    def rest_send(self):
        ...
        return self._rest_send_property.get_value()
    @rest_send.setter
    def rest_send(self, value):
        self._rest_send_property.set_value(value)
